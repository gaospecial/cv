...
- `index.html`: The final output of the template when the header variable `PDF_EXPORT` is set to `FALSE`. View it at [r.bio-spring.info/cv](http://bio-spring.info/cv).
